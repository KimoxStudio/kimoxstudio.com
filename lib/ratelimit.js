...
function buildLimiters() {
  ...
  // Accept env vars from either direct Upstash signup or Vercel
  // Marketplace's Redis integration (which is also Upstash under the
  // hood but names the vars differently when auto-provisioned).
  const url =
