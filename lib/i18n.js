...
export const I18N = {
  ...
  work: {
    ...
    items: [
      ...
      {
        n: "03",
        name: { es: "Próximamente", en: "In the kiln", ja: "制作中" },
        url: { es: "bajo NDA", en: "under NDA", ja: "NDA下" },
        year: "2026",
        category: { es: "SaaS · B2B", en: "SaaS · B2B", ja: "SaaS · B2B" },
        body: {
          es: "Plataforma SaaS para automatización de operaciones. Lanzamiento previsto Q2.",
          en: "SaaS platform for operations automation. Q2 launch.",
          ja: "オペレーション自動化のためのSaaSプラットフォーム。Q2ローンチ予定。"
        },
        tags: ["TBA", "TBA", "TBA"]
      }
    ],
    ...
    team: [
      {
        ...
        role: { es: "Fundador · Desarrollo", en: "Founder · Development", ja: "創業者 · 開発" },
        bio: {
          es: "Cabeza técnica del estudio. Diseña las arquitecturas, escribe el código que más duele y se obsesiona con el rendimiento.",
          en: "Studio's technical lead. Designs the architecture, writes the code that hurts most, and obsesses over performance.",
          ja: "スタジオの技術リード。アーキテクチャを設計し、最も難しいコードを書き、パフォーマンスにこだわります。"
        },
        skills: ["Next.js", "Postgres", "DevOps", "SEO"]
      },
      {
        initials: "B",
        name: "Nombre Apellido",
        role: { es: "Fundadora · Diseño & Producto", en: "Founder · Design & Product", ja: "創業者 · デザイン & プロダクト" },
        bio: {
          es: "La voz del cliente dentro del estudio. Diseña interfaces que se entienden y prototipos que se prueban antes de programar.",
          en: "The client's voice inside the studio. Designs interfaces that make sense and prototypes that get tested before any code.",
          ja: "スタジオ内のクライアントの代弁者。理解しやすいインターフェイスと、コードを書く前にテストできるプロトタイプを設計します。"
        },
      ...
      },
      {
        initials: "C",
        name: "Nombre Apellido",
        role: { es: "Mobile · Full-stack", en: "Mobile · Full-stack", ja: "モバイル · フルスタック" },
        bio: {
          es: "Especialista en aplicaciones móviles y la cola larga del producto: integraciones, automatizaciones, mantenimiento crítico.",
          en: "Mobile applications specialist and the product's long tail: integrations, automations, critical maintenance.",
          ja: "モバイルアプリケーションのスペシャリスト。統合、自動化、重要な保守などプロダクトの長期運用を担当。"
        },
        skills: ["React Native", "Swift", "APIs", "QA"]
      }
    ]
  },
