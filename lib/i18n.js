...
export const I18N = {
  ...
  webService: {
    label: { es: "Web como servicio", en: "Web as a service" },
    eyebrow: { es: "Web como servicio", en: "Web as a service" },
    title: {
    ...
    price: { es: "Desde 80 €/mes", en: "From €80/mo" },
    igic: { es: "sin IGIC", en: "ex. IGIC" },
    includesLabel: { es: "Todo dentro", en: "All in" },
    feats: {
      es: [
    ...
    ctaLabel: { es: "Quiero mi web así →", en: "I want mine this way →" }
  },
  ...
  footer: {
    ...
    privacyLabel: { es: "Privacidad", en: "Privacy", ja: "プライバシー" },
    legalLabel: { es: "Aviso Legal", en: "Legal Notice", ja: "法的通知" }
  }
};
